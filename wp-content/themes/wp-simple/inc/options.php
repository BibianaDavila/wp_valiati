...
function wp_simple_customizer_scripts() {
    wp_register_script( 'wp_simple_customizer_scripts', get_template_directory_uri() . '/assets/js/customizer.js', array("jquery"), '', true  );
    wp_enqueue_script( 'wp_simple_customizer_scripts' );
}
add_action( 'customize_controls_enqueue_scripts', 'wp_simple_customizer_scripts' );

function wp_simple_customizer_styles() { ?>
	<style type="text/css">
	    .button-wp-simple-secondary{width: 80%!important;margin: 5px auto 5px auto!important; display: block!important; text-align: center!important;margin-top:15px!important;margin-bottom:15px!important;}
        ...
        .wp-simple-hide{display:none!important;}
...
<?php }
add_action( 'customize_controls_print_styles', 'wp_simple_customizer_styles', 20 );
...
Kirki::add_panel( 'banner_settings', array(
    'priority'    => 2,
    'title'       => __( 'Alterar Home', 'wp-simple' ),
    'description' => '',
) );


Kirki::add_section( 'fp_banner_options', array(
    'title'          => __( 'Fundo Home', 'wp-simple' ),
    'description'    => '',
...
Kirki::add_field( 'wp-simple-config', array(
	...
	'label'       => __( 'Status Banner Home', 'wp-simple' ),
	'section'     => 'fp_banner_options',
	'default'     => '2',
	'priority'    => 1,
	'choices'     => array(
		'1'   => __( 'Mostrar', 'wp-simple' ),
        '2'   => __( 'Demo', 'wp-simple' ),
		'3'   => __( 'Esconder', 'wp-simple' ),
	),
) );
...
Kirki::add_field( 'wp-simple-config', array(
	...
	'label'       => __( 'Cor de Fundo do Banner', 'wp-simple' ),
	'section'     => 'fp_banner_options',
	'default'     => '#ea940d',
	'priority'    => 1,
	'alpha'       => true,
	'description'   => __( 'Escolha uma cor!', 'wp-simple' ),
	'output' => array(
		array(
...
Kirki::add_field( 'wp-simple-config', array(
	...
	'label'       => __( 'Imagem de Fundo do Banner', 'wp-simple' ),
	'section'     => 'fp_banner_options',
	'default'     => '',
	'priority'    => 1,
) );
...
Kirki::add_section( 'fp_banner_customizer_options', array(
    'title'          => __( 'Conteúdo Home', 'wp-simple' ),
    'description'    => '',
    'panel'          => 'banner_settings',
    'priority'       => 1,
    'capability'     => 'edit_theme_options',
...
Kirki::add_field( 'wp-simple-config', array(
	'settings' => 'fp-banner-image',
	'label'    => __( 'Imagem - Banner', 'wp-simple' ),
	'section'  => 'fp_banner_customizer_options',
	'type'     => 'image',
	'priority' => 1,
	'default'  => '',
	'description'   => __( 'Escolha uma imagem! Deixe em branco para esconder :)', 'wp-simple' ),
) );

Kirki::add_field( 'wp-simple-config', array(
	'settings' => 'fp-banner-title',
	'label'    => __( 'Título - Banner', 'wp-simple' ),
	'section'  => 'fp_banner_customizer_options',
	'type'     => 'text',
	'priority' => 1,
	'default'  => '',
	'description'   => __( 'Este é o texto em destaque no Banner. Deixe em branco para esconder :)', 'wp-simple' ),
) );

Kirki::add_field( 'wp-simple-config', array(
	'settings' => 'fp-banner-sub-title',
	'label'    => __( 'Banner - Sub Título', 'wp-simple' ),
	'section'  => 'fp_banner_customizer_options',
	'type'     => 'text',
	'priority' => 1,
	'default'  => '',
	'description'   => __( 'Este é o texto explicativo no Banner. Deixe em branco para esconder :)', 'wp-simple' ),
) );

Kirki::add_field( 'wp-simple-config', array(
	'settings' => 'fp-banner-button-text',
	'label'    => __( 'Botão - Banner', 'wp-simple' ),
	'section'  => 'fp_banner_customizer_options',
	'type'     => 'text',
	'priority' => 1,
	'default'  => '',
	'description'   => __( 'Este é o botão no Banner. Deixe em branco para esconder :)', 'wp-simple' ),
) );
...
Kirki::add_field( 'wp-simple-config', array(
	...
	'priority' => 1,
	'default'  => '',
	'description'   => __( 'Link para o botão!', 'wp-simple' ),
